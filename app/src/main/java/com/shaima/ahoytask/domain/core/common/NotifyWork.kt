package com.shaima.ahoytask.domain.core.common
...
import com.shaima.ahoytask.WeatherActivity
...
class NotifyWork @Inject constructor(context: Context, params: WorkerParameters,
    ...
    companion object {
        ...
        const val NOTIFICATION_CHANNEL = "task_channel"
        const val NOTIFICATION_WORK = "appName_notification_work"
         ...
         fun alarm(context: Context) {
            ...
            val work = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                PeriodicWorkRequest.Builder(NotifyWork::class.java, 2, TimeUnit.DAYS)
                    .setInitialDelay(Utils.getDuration().seconds, TimeUnit.SECONDS)
